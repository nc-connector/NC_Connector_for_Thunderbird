...
function run(){
  ...
  assert(minVersion === "140.0", "strict_min_version should stay aligned with supported Thunderbird 140");
  assert(maxVersion === "157.*", "strict_max_version should stay aligned with supported Thunderbird 157");
  ...
  assert(changelog.includes("Thunderbird ESR 140") && changelog.includes("ESR 153"), "CHANGELOG.md should document the supported ESR range");

...
## Reviewer Alignment Notes (3.0.0)
...
- Separate-password follow-up dispatch is active in 3.0.0 (not feature-gated):
  options + wizard toggles are functional when password protection is enabled.
